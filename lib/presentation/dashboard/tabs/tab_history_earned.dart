...
class TabHistoryEarned extends StatefulWidget {
  const TabHistoryEarned({Key? key}) : super(key: key);

  @override
  State<TabHistoryEarned> createState() => _TabHistoryEarnedState();
}

class _TabHistoryEarnedState extends State<TabHistoryEarned> {
